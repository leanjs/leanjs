...
describe("cleanup", () => {
  it(`calls all the cleanup functions passed to the onCleanup hook of each api factory that was initialised`, async () => {
    ...
    // reading this api to boot eventEmitter1 api
