...
import type { Loader, LoaderResource } from "pixi.js";

import { Canvas } from "@art-boards/ui-canvas";
      ...
      mount={(element) => {
        ...
        function setup(_: Loader, resources: Dict<LoaderResource>) {
          ...
          function onPointerDown() {
            ...
            if (x > 800 && !robot) {
              robot = new PIXI.Sprite(resources.robot.texture);
